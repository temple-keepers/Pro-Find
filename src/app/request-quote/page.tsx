    ...
    return (
      <div className="min-h-screen bg-surface-warm flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full">
          ...
          {/* Share CTA */}
          <div className="card p-4 border border-gray-100 mb-6 text-center">
            <p className="text-sm font-medium mb-2">Know someone who needs a {tradeName.toLowerCase()}?</p>
            <a
              href={`https://wa.me/?text=${encodeURIComponent(`I just used ProFind to find a ${tradeName.toLowerCase()} in Guyana — check it out! https://profindguyana.com`)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] text-white text-sm font-semibold rounded-xl hover:bg-[#1da851] transition-colors"
            >
